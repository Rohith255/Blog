@extends('admin.index')
@section('content')
    <div class="d-flex justify-content-center pt-5" style="height: 100vh;background-color: #E8F0FD;padding-top: 15vh;">
        <div class="col-lg-4 mx-auto bg-white" style="border-radius: 14px;height: 65%;">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <form class="pt-3" method="post" action="{{route('admin.store')}}">
                    ...
                    <div class="mt-3">
                        <input type="submit" class="btn btn-block btn-lg text-white font-weight-medium auth-form-btn" value="SIGN IN" style="background-color: #007BFF">
                    </div>
                </form>
            </div>
            @if (session('error'))
